...
public class Main {
    ...
    private static void frontDeskMenu() {
        while (true) {
            ...
            System.out.println("[4] View Pricing"); // ✅ FIXED
            System.out.println("[5] Back");         // ✅ shifted
    ...
    private static void printReceipt(String first, String last,
                                     String cabinType, String cabinId,
                                     String destination, int pax,
                                     double baseAmount,
                                     double discountAmt,
                                     double vatAmt,
                                     double finalTotal,
        ...
        System.out.printf("Guest        : %s %s%n", first, last);
        System.out.printf("Cabin        : %s (%s)%n", cabinType, cabinId);
        System.out.printf("Destination  : %s%n", destination);
        System.out.printf("Guests       : %d%n", pax);

        System.out.println("---------------------------------------");

        System.out.printf("SUBTOTAL     : ₱%.2f%n", baseAmount);
        System.out.printf("Discount     : ₱%.2f%n", discountAmt);
        System.out.printf("VAT (12%%)    : ₱%.2f%n", vatAmt);
        System.out.printf("FINAL TOTAL  : ₱%.2f%n", finalTotal);

        System.out.println("---------------------------------------");

        System.out.printf("Reference No : %s%n", reference);
